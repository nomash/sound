...
class Track(models.Model):
    id = models.UUIDField(primary_key=True, db_column='track_guid')
    user = models.ForeignKey(
        'User', models.DO_NOTHING, blank=True, null=True,
        db_column='track_user', related_name='tracks')
    time = models.IntegerField()
    created = models.DateTimeField(
        blank=True, null=True, db_column='created')
    updated = models.DateTimeField(
        blank=True, null=True, db_column='updated')
